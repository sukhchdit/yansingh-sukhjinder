...
namespace Cosmos.DAL.Migrations
{
    ...
    [Migration("20230415060106_second")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Cosmos.Model.Entities.Country", b =>
                {
                    b.Property<long>("id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Cosmos.Model.Entities.Organization.OrganizationContact", b =>
                {
                    b.Property<long>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Cosmos.Model.Entities.Organization.OrganizationInfo", b =>
                {
                    b.Property<long>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Cosmos.Model.Entities.Right", b =>
                {
                    b.Property<long>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Cosmos.Model.Entities.State", b =>
                {
                    b.Property<long>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Cosmos.Models.Entities.Account.User", b =>
                {
                    b.Property<long>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Cosmos.Models.Entities.Account.UserSession", b =>
                {
                    b.Property<long>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Cosmos.Models.Entities.Maid.MaidDetail", b =>
                {
                    b.Property<long>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Cosmos.Models.Entities.Maid.MaidDuty", b =>
                {
                    b.Property<long>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Cosmos.Models.Entities.Maid.MaidExperience", b =>
                {
                    b.Property<long>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Cosmos.Models.Entities.Maid.MaidExperienceJobDuty", b =>
                {
                    b.Property<long>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Cosmos.Model.Entities.Organization.OrganizationContact", b =>
                {
                    b.HasOne("Cosmos.Model.Entities.Organization.OrganizationInfo", "organizationInfo")
                        .WithMany("OrganizationContacts")
                        .HasForeignKey("organizationInfoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Cosmos.Models.Entities.Account.User", "user")
                        .WithOne("OrganizationContact")
                        .HasForeignKey("Cosmos.Model.Entities.Organization.OrganizationContact", "userId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Cosmos.Model.Entities.State", b =>
                {
                    b.HasOne("Cosmos.Model.Entities.Country", "country")
                        .WithMany()
            ...
            modelBuilder.Entity("Cosmos.Models.Entities.Maid.MaidDuty", b =>
                {
                    b.HasOne("Cosmos.Models.Entities.Maid.MaidDetail", "maidDetail")
                        .WithMany("maidDuty")
            ...
            modelBuilder.Entity("Cosmos.Models.Entities.Maid.MaidExperienceJobDuty", b =>
                {
                    b.HasOne("Cosmos.Models.Entities.Maid.MaidExperience", "maidExperience")
                        .WithMany("maidExperienceJobDuty")
